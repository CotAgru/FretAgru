...
import DashboardFretes from './pages/frete/Dashboard'
import Cadastros from './pages/Cadastros'
import Veiculos from './pages/frete/Veiculos'
import Produtos from './pages/Produtos'
import Precos from './pages/frete/Precos'
import Ordens from './pages/frete/Ordens'
import Romaneios from './pages/frete/Romaneios'
import Operacoes from './pages/frete/Operacoes'
import Admin from './pages/Admin'
import Importacao from './pages/frete/Importacao'
import DashboardContratos from './pages/contratos/DashboardContratos'
import ContratosVenda from './pages/contratos/ContratosVenda'
import CompraInsumos from './pages/contratos/CompraInsumos'
